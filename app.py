...
def menu():
    ...
    st.sidebar.page_link("page/1_phan_tich_du_lieu.py", label="Phân tích dữ liệu")
    st.sidebar.page_link("page/2_them_du_lieu_test.py", label="Thêm dữ liệu cho tập test")
    st.sidebar.page_link("page/3_du_doan_mo_hinh.py", label="Phân tích dự đoán")
